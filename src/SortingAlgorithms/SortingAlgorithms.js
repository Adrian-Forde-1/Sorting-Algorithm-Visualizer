...
export default class SortingVisualizer extends Component {
  ...
  componentDidMount() {
    ...
    document.documentElement.style.setProperty(
      "--view-port-width",
      `${ViewPortWidth / (NUMBER_OF_ARRAY_BARS * widthScaling)}px`
    );

    document.getElementById("current-algorithm").innerHTML = currentAlgo;

    document.querySelector("#value").innerHTML = NUMBER_OF_ARRAY_BARS;
  ...
  resetArray() {
    ...
    if (NUMBER_OF_ARRAY_BARS < 200) widthScaling = 3;
    else widthScaling = 3;
